...
public class QuestionBankQuestionController {
  ...
  @Resource private QuestionBankQuestionService questionBankQuestionService;
  ...
  public BaseResponse<Boolean> deleteQuestionBankQuestion(
    ...
    // 仅本人或管理员可删除
    if (!oldQuestionBankQuestion.getUserId().equals(user.getId())
   ...
   */
  @GetMapping("/get/vo")
  public BaseResponse<QuestionBankQuestionVO> getQuestionBankQuestionVOById(
    ...
    return ResultUtils.success(
        questionBankQuestionService.getQuestionBankQuestionVO(questionBankQuestion, request));
  }
  ...
  public BaseResponse<Page<QuestionBankQuestion>> listQuestionBankQuestionByPage(
    ...
    Page<QuestionBankQuestion> questionBankQuestionPage =
        questionBankQuestionService.page(
