...
@Service
@Slf4j
public class QuestionBankQuestionServiceImpl
    extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion>
  ...
  public QuestionBankQuestionVO getQuestionBankQuestionVO(
    ...
    QuestionBankQuestionVO questionBankQuestionVO =
        QuestionBankQuestionVO.objToVo(questionBankQuestion);
  ...
  public Page<QuestionBankQuestionVO> getQuestionBankQuestionVOPage(
    ...
    // 填充信息
    questionBankQuestionVOList.forEach(
