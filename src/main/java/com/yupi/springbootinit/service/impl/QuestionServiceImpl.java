...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
   ...
   */
  @Override
  public Page<QuestionVO> getQuestionVOPage(
      Page<Question> questionPage, HttpServletRequest request) {
  ...
  public Page<Question> ListQuestionByPage(QuestionQueryRequest questionQueryRequest) {
    ...
    List<QuestionBankQuestion> list =
        questionBankQuestionService.list(
    ...
    List<Long> questionIdList =
        list.stream().map(QuestionBankQuestion::getQuestionId).collect(Collectors.toList());
